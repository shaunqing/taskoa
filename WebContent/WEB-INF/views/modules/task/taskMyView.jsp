		...
		<div class="row">
			<div class="col-lg-6">
				<div class="panel panel-default">
					<div class="panel-heading">任务详情查看</div>
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<div class="form-group">
									<label>任务名称：${mytask.taskname}</label>
								</div>
								<div class="form-group">
									<label>任务编号：${mytask.taskno}</label>
								</div>
								<div class="form-group">
									<label>执行人：${mytask.operator.username}</label>
								</div>
								<div class="form-group">
									<label>创建时间：${fn:substring(mytask.time_created,0,16)}</label>
								</div>
								<div class="form-group">
									<label>开始时间：${fn:substring(mytask.time_start,0,16)}</label>
								</div>
								<div class="form-group">
									<label>结束时间：${fn:substring(mytask.time_end,0,16)}</label>
								</div>
								<div class="form-group">
									<label>任务状态：${mytask.taskstat}</label>
								</div>
								<div class="form-group">
									<label>任务描述：</label>
											...
											<c:otherwise>
												<c:forEach items="${file1}" var="file1">
													<tr>
														...
														<td>${fn:substring(file1.operatime,0,16)}</td>
														<td>
											...
											<c:otherwise>
												<c:forEach items="${file0}" var="file0">
													<tr>
														...
														<td>${fn:substring(file0.operatime,0,16)}</td>
														<td>
